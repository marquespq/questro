  ...
  const simulateProgress = () => {
    if (activeQuests.length > 0) {
      ...
      if (objective) {
        ...
        addPoints(10, { action: 'quest-progress', description: 'Quest progress made' });
          ...
          {activeQuests.length > 0 && (
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <button onClick={simulateProgress} style={styles.actionButton}>
                  ➕ Make Progress (+1)
                </button>
                <button
...
/>`}</pre>
        ...
        <div style={styles.codeBlock}>
          ...
          <pre style={styles.codeSnippet}>{`const { startQuest, updateProgress } = useQuests();
