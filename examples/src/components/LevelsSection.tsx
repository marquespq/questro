        ...
        <div className="demo-card">
          ...
          >
            ...
            <div style={{ fontSize: '13px', color: '#166534', lineHeight: '1.6' }}>
              ...
              <br />
              <strong>Formulas:</strong> Different progression curves (linear, exponential,
              fibonacci, rpg)
            </div>
          </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            >
              ...
              <span style={{ fontSize: '14px', color: '#64748b' }}>{progress.toFixed(1)}%</span>
            </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            >
              {selectedFormula === 'linear' && 'Consistent XP increase (100, 200, 300...)'}
              {selectedFormula === 'exponential' && 'Progressive difficulty (100, 150, 225...)'}
              {selectedFormula === 'fibonacci' && 'Natural growth (100, 150, 250...)'}
              {selectedFormula === 'rpg' && 'RPG-style scaling (100, 110, 121...)'}
            </div>
          </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div className="demo-actions">
              <button onClick={() => handleAddXP(25)} className="action-button">
                🎯 Task +25 XP
              </button>
              <button onClick={() => handleAddXP(50)} className="action-button">
                ⭐ Quest +50 XP
              </button>
              <button onClick={() => handleAddXP(100)} className="action-button">
                🏆 Achievement +100 XP
              </button>
              <button onClick={() => handleRemoveXP(20)} className="action-button-danger">
                ⚠️ Penalty -20 XP
              </button>
            </div>
          </div>
